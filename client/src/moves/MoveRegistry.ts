...
const MOVE_DEFS: MoveDef[] = [
  ...
  { type: MoveType.HIGH_PUNCH, damage: 8, duration: 40, hitFrame: 3, locksPlayer: true, returnTo: MoveType.STAND },
  { type: MoveType.LOW_PUNCH, damage: 5, duration: 40, hitFrame: 2, locksPlayer: true, returnTo: MoveType.STAND },
  { type: MoveType.HIGH_KICK, damage: 10, duration: 40, hitFrame: 4, locksPlayer: true, returnTo: MoveType.STAND },
  { type: MoveType.LOW_KICK, damage: 6, duration: 40, hitFrame: 3, locksPlayer: true, returnTo: MoveType.STAND },
  { type: MoveType.UPPERCUT, damage: 13, duration: 60, hitFrame: 3, locksPlayer: true, returnTo: MoveType.STAND },
  { type: MoveType.SPIN_KICK, damage: 13, duration: 60, hitFrame: 4, locksPlayer: true, returnTo: MoveType.STAND },
  { type: MoveType.JUMP, damage: 0, duration: 120, hitFrame: -1, locksPlayer: true, returnTo: MoveType.STAND, velocityY: -6 },
  ...
  { type: MoveType.BACKWARD_JUMP, damage: 0, duration: 120, hitFrame: -1, locksPlayer: true, returnTo: MoveType.STAND, velocityX: -5, velocityY: -6 },
  { type: MoveType.FORWARD_JUMP_KICK, damage: 10, duration: 120, hitFrame: 1, locksPlayer: true, returnTo: MoveType.STAND, velocityX: 5, velocityY: -6 },
  { type: MoveType.BACKWARD_JUMP_KICK, damage: 10, duration: 120, hitFrame: 1, locksPlayer: true, returnTo: MoveType.STAND, velocityX: -5, velocityY: -6 },
  { type: MoveType.FORWARD_JUMP_PUNCH, damage: 9, duration: 120, hitFrame: 1, locksPlayer: true, returnTo: MoveType.STAND, velocityX: 5, velocityY: -6 },
  { type: MoveType.BACKWARD_JUMP_PUNCH, damage: 9, duration: 120, hitFrame: 1, locksPlayer: true, returnTo: MoveType.STAND, velocityX: -5, velocityY: -6 },
